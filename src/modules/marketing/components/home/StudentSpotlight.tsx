...
const SpotlightCard = ({
  ...
  <div className="bg-primary w-full md:w-[762px] h-fit md:h-[562px] p-5 md:p-10 space-y-[32px]">
    <VideoPlayer
...
const StudentSpotLight = () => {
  return (
    <section>
      <Container className="w-full h-fit gap-8 flex md:justify-between md:flex-row flex-col py-10 lg:py-20 relative">
        <div className="w-full md:w-[35%] h-fit space-y-[16px] md:sticky md:top-[30%] self-start">
