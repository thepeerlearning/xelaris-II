    ...
    <section className=" min-h-[640px] lg:min-h-[calc(100%-80px)] relative overflow-hidden lg:py-20">
      <Container className="flex items-center h-full gap-10 lg:flex-row flex-col py-8">
        <div className="flex flex-col lg:w-[40%]">
          <div>
            <h1 className="mb-5 text-4xl md:text-5xl  font-medium   capitalize lg:leading-14">
              The best place <br className="hidden lg:block" /> for kids/teens{" "}
              to learn tech skills. <br />
              <span className="text-primary italic font-semibold underline font-spectral max-lg:text-5xl text-6xl">
                Guaranteed.
              </span>
            </h1>
            ...
            <p className="text-white mb-10 flex items-center gap-1">
              {" "}
              <svg
                width="32"
                height="25"
